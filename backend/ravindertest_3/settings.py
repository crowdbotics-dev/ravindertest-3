"""
Django settings for ravindertest_3 project.
...
ROOT_URLCONF = 'ravindertest_3.urls'
...
WSGI_APPLICATION = 'ravindertest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravindertest_3 API",
    "DESCRIPTION": "API documentation for ravindertest_3 App",
    "VERSION": "v1",
}
